...
//
describe("Campaign", () => {
  it("deploy factory and a campaign", () => {
  ...
  it("allow to contribute money", async () => {
  ...
  it("allow to make payment request", async () => {
  ...
  it("proccesses request", async () => {
    ...
    await campaign.methods
      .createRequest("Buy Bat", web3.utils.toWei("5", "ether"), accounts[1])
      .send({
        from: accounts[0],
        gas: "5000000"
      });
